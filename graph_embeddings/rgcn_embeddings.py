...
def rgcn_embeddings(graph):
    ...
    target_csv = os.path.join(os.getcwd(),'data','completeDataset.csv')
    ...
    #train model
    train_rgcn(training_model, [X] + A, y_train, y_val, idx_train, idx_val, epochs=50, train_mask=train_mask)
    #get embeddings
